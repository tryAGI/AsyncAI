...
namespace AsyncAI.CLI;

internal static class CliRuntime
{
    private const string UserSecretsId = "AsyncAI.CLI";
    private const string UserSecretApiKeyName = "ASYNCAI_API_KEY";
    private static readonly string[] ApiKeyEnvironmentVariables = [@"ASYNCAI_API_KEY"];
    private const string CredentialFileDirectoryName = ".async-ai";

    public static async global::System.Threading.Tasks.Task<global::AsyncAI.AsyncAIClient> CreateClientAsync(ParseResult parseResult, CancellationToken cancellationToken = default)
    {
        ...
        var authorizations = string.IsNullOrWhiteSpace(apiKey)
            ? new global::System.Collections.Generic.List<global::AsyncAI.EndPointAuthorization>()
            : new global::System.Collections.Generic.List<global::AsyncAI.EndPointAuthorization>
            {
        CreateAuthorization(
            type: "ApiKey",
        ...
        return new global::AsyncAI.AsyncAIClient(
            httpClient: null,
            baseUri: baseUri,
    ...
    private static global::AsyncAI.EndPointAuthorization CreateAuthorization(
        string type,
        string schemeId,
        string location,
        string name,
        string value)
    {
        var authorization = new global::AsyncAI.EndPointAuthorization
        {
            Type = type,
            Location = location,
            Name = name,
        ...
        var schemeIdProperty = typeof(global::AsyncAI.EndPointAuthorization).GetProperty("SchemeId");
    ...
    public static async global::System.Threading.Tasks.Task<int> RunAsync(Func<global::System.Threading.Tasks.Task> action, CancellationToken cancellationToken = default)
    {
        ...
        catch (global::AsyncAI.ApiException exception)
        {
    ...
    private static Uri? ResolveBaseUri(ParseResult parseResult)
    {
        ...
        {
            baseUrl = Environment.GetEnvironmentVariable("ASYNCAI_BASE_URL");
        }
    ...
    private static async global::System.Threading.Tasks.Task WriteApiExceptionAsync(global::AsyncAI.ApiException exception)
    {
        var builder = new StringBuilder();
