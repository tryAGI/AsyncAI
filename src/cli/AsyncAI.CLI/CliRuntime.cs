...
internal static class CliRuntime
{
    ...
    public static async Task<global::AsyncAI.AsyncAIClient> CreateClientAsync(ParseResult parseResult, CancellationToken cancellationToken = default)
    {
    ...
    private static async Task WriteApiExceptionAsync(global::AsyncAI.ApiException exception)
    {
        var builder = new StringBuilder();
