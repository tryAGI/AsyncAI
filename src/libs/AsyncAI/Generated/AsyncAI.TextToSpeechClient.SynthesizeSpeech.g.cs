...
namespace AsyncAI
{
    public partial class TextToSpeechClient
    {
        ...
        private static readonly global::AsyncAI.EndPointSecurityRequirement s_SynthesizeSpeechSecurityRequirement0 =
        ...
        private static readonly global::AsyncAI.EndPointSecurityRequirement[] s_SynthesizeSpeechSecurityRequirements =
            new global::AsyncAI.EndPointSecurityRequirement[]
                ...
                else
                {
                    await global::AsyncAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            try
                            {
                                ...
                                return new global::AsyncAI.ResponseStream(__response, __content);
                            }
                            catch (global::System.Exception __ex)
                            {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::AsyncAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::AsyncAI.AutoSDKHttpResponse<byte[]>> SynthesizeSpeechAsResponseAsync(
                    ...
                    await global::AsyncAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    return new global::AsyncAI.AutoSDKHttpResponse<byte[]>(
                                        statusCode: __response.StatusCode,
