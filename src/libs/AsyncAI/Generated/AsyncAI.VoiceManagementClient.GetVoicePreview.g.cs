...
namespace AsyncAI
{
    public partial class VoiceManagementClient
    {
        ...
        private static readonly global::AsyncAI.EndPointSecurityRequirement s_GetVoicePreviewSecurityRequirement0 =
        ...
        private static readonly global::AsyncAI.EndPointSecurityRequirement[] s_GetVoicePreviewSecurityRequirements =
            new global::AsyncAI.EndPointSecurityRequirement[]
            {                s_GetVoicePreviewSecurityRequirement0,
            };
        partial void PrepareGetVoicePreviewArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string id,
            ref string? version);
        partial void PrepareGetVoicePreviewRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string id,
            string? version);
        partial void ProcessGetVoicePreviewResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetVoicePreviewResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);

        /// <summary>
        /// Get voice preview<br/>
        ...
        public async global::System.Threading.Tasks.Task<global::AsyncAI.VoicePreviewResponse> GetVoicePreviewAsync(
            string id,
            string? version = default,
            global::AsyncAI.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await GetVoicePreviewAsResponseAsync(
                id: id,
                version: version,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::AsyncAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::AsyncAI.AutoSDKHttpResponse<global::AsyncAI.VoicePreviewResponse>> GetVoicePreviewAsResponseAsync(
            string id,
            string? version = default,
            global::AsyncAI.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetVoicePreviewArguments(
            ...
            var __authorizations = global::AsyncAI.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetVoicePreviewSecurityRequirements,
                operationName: "GetVoicePreviewAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::AsyncAI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::AsyncAI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "GetVoicePreviewAsync",
                                pathTemplate: "$\"/voices/preview/{id}\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetVoicePreviewResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::AsyncAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetVoicePreviewResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::AsyncAI.VoicePreviewResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::AsyncAI.AutoSDKHttpResponse<global::AsyncAI.VoicePreviewResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::AsyncAI.VoicePreviewResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
