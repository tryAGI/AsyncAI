...
namespace AsyncAI
{
    ...
    public sealed class AutoSDKClientOptions
    {
        ...
        /// </summary>
        public global::AsyncAI.AutoSDKRetryOptions Retry { get; set; } = new global::AsyncAI.AutoSDKRetryOptions();
        ...
        /// </summary>
        public global::System.Collections.Generic.List<global::AsyncAI.IAutoSDKHook> Hooks { get; } =
            new global::System.Collections.Generic.List<global::AsyncAI.IAutoSDKHook>();
        ...
        public global::AsyncAI.AutoSDKClientOptions AddHook(
            global::AsyncAI.IAutoSDKHook hook)
        {
        ...
        /// </summary>
        public global::AsyncAI.IAutoSDKAuthorizationProvider? AuthorizationProvider { get; set; }
        ...
        public global::AsyncAI.AutoSDKClientOptions UseAuthorizationProvider(
            global::AsyncAI.IAutoSDKAuthorizationProvider provider)
        {
            AuthorizationProvider = provider ?? throw new global::System.ArgumentNullException(nameof(provider));
            if (Hooks.Find(static x => x is global::AsyncAI.AutoSDKAuthorizationProviderHook) == null)
            {
                Hooks.Add(new global::AsyncAI.AutoSDKAuthorizationProviderHook());
            }
    ...
    public readonly struct AutoSDKAuthorizationValue
    {
        ...
        public static global::AsyncAI.AutoSDKAuthorizationValue Bearer(string token) => new(value: token, scheme: "Bearer");

        /// <summary>Convenience factory for an API-key header.</summary>
        public static global::AsyncAI.AutoSDKAuthorizationValue ApiKeyHeader(string name, string value) =>
    ...
    public interface IAutoSDKAuthorizationProvider
    {
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::AsyncAI.AutoSDKAuthorizationValue>?> ResolveAsync(
            global::AsyncAI.AutoSDKHookContext context);
    }
...
#pragma warning restore CS0618
    ...
    /// </summary>
    public sealed class AutoSDKAuthorizationProviderHook : global::AsyncAI.AutoSDKHook
    {
        /// <inheritdoc />
            ...
            global::AsyncAI.AutoSDKHookContext context)
        {
            ...
            if (perRequest != null && perRequest.Count > 0)
            {
                ...
                global::AsyncAI.AutoSDKHttpRequestOptions.StampAuthorizationOverride(context.Request);
                return;
            }
        ...
        private static void ApplyAuthorization(
            global::System.Net.Http.HttpRequestMessage request,
            global::AsyncAI.AutoSDKAuthorizationValue authorization)
        {
    ...
    public sealed class AutoSDKRequestOptions
    {
        ...
        /// </summary>
        public global::AsyncAI.AutoSDKRetryOptions? Retry { get; set; }
        ...
        /// </summary>
        public global::System.Collections.Generic.IReadOnlyList<global::AsyncAI.AutoSDKAuthorizationValue>? Authorizations { get; set; }
    }
    ...
    /// </summary>
    public abstract class AutoSDKHook : global::AsyncAI.IAutoSDKHook
    {
        /// <inheritdoc />
    ...
    public sealed class AutoSDKHookContext
    {
        ...
        /// </summary>
        public global::AsyncAI.AutoSDKClientOptions ClientOptions { get; set; } = null!;

        /// <summary>
        /// The per-request runtime options.
        /// </summary>
        public global::AsyncAI.AutoSDKRequestOptions? RequestOptions { get; set; }
    ...
    {
        internal static global::AsyncAI.AutoSDKHookContext CreateHookContext(
            string operationId,
            string methodName,
            string pathTemplate,
            string httpMethod,
            ...
            global::AsyncAI.AutoSDKClientOptions clientOptions,
            global::AsyncAI.AutoSDKRequestOptions? requestOptions,
            int attempt,
            int maxAttempts,
            bool willRetry,
        ...
        {
            return new global::AsyncAI.AutoSDKHookContext
            {
        ...
        internal static global::System.TimeSpan GetRetryDelay(
            ...
            int attempt)
        {
            var retryOptions = requestOptions?.Retry ?? clientOptions.Retry ?? new global::AsyncAI.AutoSDKRetryOptions();
        ...
        private static global::System.TimeSpan ClampRetryDelay(
            global::System.TimeSpan delay,
            global::AsyncAI.AutoSDKRetryOptions retryOptions)
        {
        ...
        private static async global::System.Threading.Tasks.Task InvokeHooksAsync(
            global::AsyncAI.AutoSDKClientOptions clientOptions,
            global::System.Func<global::AsyncAI.IAutoSDKHook, global::AsyncAI.AutoSDKHookContext, global::System.Threading.Tasks.Task> callback,
            global::AsyncAI.AutoSDKHookContext context)
        {
