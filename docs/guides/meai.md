...
The AsyncAI SDK provides integration with [Microsoft.Extensions.AI](https://learn.microsoft.com/en-us/dotnet/ai/microsoft-extensions-ai), enabling seamless interoperability with the unified .NET AI abstractions.

## Installation

```bash
dotnet add package AsyncAI
```
...
using var client = new AsyncAIClient(
    apiKey: Environment.GetEnvironmentVariable("ASYNCAI_API_KEY")!);
